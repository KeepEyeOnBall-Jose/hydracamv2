...
| Xiaomi 2201116PG / Android 13 API 33 / `575ecf2cbd24` | Conditional | Current-build install, unattended update, launch, and Master Control UI smoke. | The user cleared the Xiaomi account/SIM gate on 2026-07-14. `logs/verification-runs/20260714-1502-poco-x4-install-after-xiaomi-account/` proves app `1.4.0+19`, PID, package metadata, screenshot, video, and clean startup logs. Camera capture, upload, and multi-device session support remain unproven; join the fleet LAN before that matrix. |
