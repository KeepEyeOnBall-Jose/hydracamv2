...
- Elapsed seconds: `9.746`

| Phase | Count | Min ms | Avg ms | Max ms |
| --- | ---: | ---: | ---: | ---: |
| `connected_clients` | `20` | `17.831` | `148.307` | `240.74` |
| `master_commands` | `20` | `1.052` | `29.815` | `83.346` |
| `set_role` | `20` | `167.562` | `304.915` | `444.654` |

| Runtime Switch Metric | Count | Min ms | Avg ms | Max ms |
| --- | ---: | ---: | ---: | ---: |
| `parallelRequestStartSkewMs` | `20` | `0.311` | `0.432` | `0.608` |
| `requestStartSkewMs` | `20` | `29.468` | `136.429` | `241.116` |
| `requestEndSkewMs` | `20` | `131.836` | `185.693` | `253.286` |
| `maxRequestDurationMs` | `20` | `129.123` | `170.791` | `251.641` |

| Client Registration Metric | Count | Min ms | Avg ms | Max ms |
| --- | ---: | ---: | ---: | ---: |
| `masterServerStartLagMs` | `20` | `-299.655` | `-9.711` | `325.482` |
| `latestClientRegistrationLagMs` | `20` | `-27.199` | `270.272` | `624.347` |
| `maxClientRegistrationAfterServerStartMs` | `20` | `216.739` | `279.983` | `326.905` |
