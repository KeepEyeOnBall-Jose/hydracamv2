...
- Elapsed seconds: `9.071`

| Phase | Count | Min ms | Avg ms | Max ms |
| --- | ---: | ---: | ---: | ---: |
| `connected_clients` | `20` | `103.937` | `215.01` | `607.55` |
| `master_commands` | `20` | `0.658` | `16.173` | `43.039` |
| `set_role` | `20` | `125.437` | `220.192` | `964.287` |

| Runtime Switch Metric | Count | Min ms | Avg ms | Max ms |
| --- | ---: | ---: | ---: | ---: |
| `requestStartSkewMs` | `20` | `0.262` | `0.417` | `0.737` |
| `requestEndSkewMs` | `20` | `93.271` | `191.267` | `875.658` |
| `maxRequestDurationMs` | `20` | `125.215` | `219.812` | `964.067` |

| Client Registration Metric | Count | Min ms | Avg ms | Max ms |
| --- | ---: | ---: | ---: | ---: |
| `masterServerStartLagMs` | `20` | `-310.387` | `56.583` | `738.36` |
| `latestClientRegistrationLagMs` | `20` | `-191.215` | `262.33` | `1352.102` |
| `maxClientRegistrationAfterServerStartMs` | `20` | `77.065` | `205.747` | `613.742` |
