...
void main() {
  ...
  testWidgets("explicit upload action visual proof", (tester) async {
    await tester.binding.setSurfaceSize(const Size(430, 300));
    final tempDir =
        Directory.systemTemp.createTempSync("hydracam_upload_actions_visual");
    addTearDown(() async {
    ...
    await expectLater(
      ...
      matchesGoldenFile("screenshots/explicit_upload_actions.png"),
    );
  });
}
