...
- Elapsed seconds: `8.806`

| Phase | Count | Min ms | Avg ms | Max ms |
| --- | ---: | ---: | ---: | ---: |
| `connected_clients` | `25` | `69.514` | `208.898` | `424.785` |
| `set_role` | `25` | `48.489` | `140.408` | `247.62` |

| Runtime Switch Metric | Count | Min ms | Avg ms | Max ms |
| --- | ---: | ---: | ---: | ---: |
| `parallelRequestStartSkewMs` | `25` | `0.342` | `0.473` | `0.897` |
| `requestStartSkewMs` | `25` | `15.786` | `95.116` | `147.35` |
| `requestEndSkewMs` | `25` | `30.816` | `66.631` | `152.984` |
| `maxRequestDurationMs` | `25` | `23.936` | `82.146` | `135.777` |

| Client Registration Metric | Count | Min ms | Avg ms | Max ms |
| --- | ---: | ---: | ---: | ---: |
| `masterServerStartLagMs` | `25` | `-351.648` | `59.548` | `508.336` |
| `latestClientRegistrationLagMs` | `25` | `-121.896` | `302.041` | `887.853` |
| `maxClientRegistrationAfterServerStartMs` | `25` | `151.658` | `242.493` | `395.999` |
