...
const fs = require('fs');
const url = "http://localhost:5173/events/hydracam-wearable-live-1782146179386192/videos/92691e90-2640-4955-b8ed-be59146da47d";
const resultPath = "/Users/jose/src/work/hydracamv2/logs/verification-runs/browser-proof-smoke/browser-proof.json";
(async () => {
