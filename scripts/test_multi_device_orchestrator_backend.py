...
class MultiDeviceOrchestratorBackendTests(unittest.TestCase):
    ...
    def test_extract_session_guid_from_nested_command_response(self) -> None:
        ...
        response = {
            ...
            "result": {
                "sessionGuid": "nested-guid-123",
            },
        }

        session_guid = orchestrator._extract_session_guid_from_command_response(response)

        self.assertEqual(session_guid, "nested-guid-123")
