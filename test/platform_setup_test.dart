  ...
  group("Platform Setup Tests", () {
    test("iOS Podfile should exist and be valid", () {
      ...
      expect(podfile.existsSync(), isTrue,
          reason:
              'ios/Podfile does not exist. Please run "flutter create ." to regenerate it.');
    ...
    test("Android build.gradle should exist", () {
      ...
      expect(buildGradle.existsSync(), isTrue,
          reason:
              'android/build.gradle does not exist. Please run "flutter create ." to regenerate it.');
    });
    ...
    test("Web index.html should exist", () {
      ...
      expect(indexHtml.existsSync(), isTrue,
          reason:
              'web/index.html does not exist. Please run "flutter create ." to regenerate it.');
    });
  });
}
